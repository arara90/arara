      ...
      <div id="main">
         <div class="top-wrapper clear">
            <div id="content">
                  ...
                  <tbody>
                   ...
                   <%--   <%
                     ...
                     <tr>
                        ...
                        <td class="title"><a href="notice-detail?c=${n.code}">${n.title}</a></td>
                ...
                <%--        
                     ...
                     --%>
                        ...
                        <c:forEach var="n" items="${list}" varStatus="s">
                          ...
                          <tr>
                        <td class="seq">${n.code} </td>
                        <td class="title">${s.index} : <a href="notice-detail?c=${n.code}">${n.title}</a>
                        [<span style = "color:red"> ${n.cmtCnt}</span>]</td>
               ...
               <p>              
            			<c:forTokens var="n" items="1,2,3,4,5" delims=",">
            			${n+1} /
            			</c:forTokens>
               	</p>
               ...
               <div id="pager-wrapper" class="margin-small">
                  <div class="pager clear">
                     ...
                     <ul>
                        <li>
                           <a class="strong" "notice?f=${param.f} &q=${param.q}&pg=1">1</a>
                        </li>
                        <li>
                           <a href="notice?pg=2"> 2 </a>
                        </li>
                        <li>
                           <a href="notice?pg=3"> 3 </a>
                        </li>
                        <li>
                            <a href="notice?pg=4"> 4 </a>
                        </li>
                        <li>
                             <a href="notice?5">5 </a>
                        </li>
