				...
				<div id="content">
					...
					<%-- 
 						...
 						/*  for(Notice n : list){
							...
							<tr>
								<td class="seq">${list[0].code}</td>
								<td class="title"><a href="notice-detail?c=${list[0].code}">${list[0].title}</a></td>
								<td class="writer">${list[0].writer}</td>
								<td class="regdate">${list[0].hit}</td>
							</tr>
